...
// The list Template ( The image on top )
// no direct access
...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2ItemsBlock k2ListsModule">
    ...
    <article class="<?php echo ($key%2) ? "odd" : "even"; ?>">
	 ...
	 <?php if($params->get('itemImage') && isset($item->image)): ?>
      ...
      <span class="moduleItemDateCreated"><?php echo JText::_('k2_ON') ;?> <?php echo JHTML::_('date', $item->created, JText::_('K2_DATE_FORMAT_LC2')); ?></span>
      <?php endif; ?>
