...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2UserBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?> isFontIstok">
  ...
  <h4 class="closeSlide" style="display:none;">Hide</h4>
	<h4 class="openSlide">Expand</h4>
</div>
