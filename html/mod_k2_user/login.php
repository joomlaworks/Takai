...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2LoginBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?> isFontIstok">
	...
	<h4 class="closeSlide" style="display:none; "><?php echo $module->title; ?></h4>
	<h4 class="openSlide"><?php echo $module->title; ?></h4>
</div>
